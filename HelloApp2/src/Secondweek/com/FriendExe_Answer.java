...
//					CompFriend univ = (CompFriend) friends[i];
					((ComFriend) friends[i]).setCompany(info1);
					((ComFriend) friends[i]).setDepartment(info2);
	...
	public void register() {
		...
		if (menu == 1) {
			...
			friends[friendNum++] = new ComFriend(name, phone, company, dept);
