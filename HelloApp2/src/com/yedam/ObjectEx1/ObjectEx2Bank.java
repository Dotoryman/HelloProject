...
//                  String selectWho = scn.nextLine();
//                  b1.owner = selectWho;
//                  System.out.println("잔고를 적어주세요");
//                  int selectMon = Integer.parseInt(scn.nextLine());
...
//            boolean tun1 = false;
//            String selectNum3 = scn.nextLine();
//            for(int i =0 ; i<accounts.length;i++) {
//               if(selectNum3.equals(accounts[i].accountNo)) {
//                  System.out.println("입급하실 금액을 입력하세요");
//                  int selectMon1=Integer.parseInt(scn.nextLine());
